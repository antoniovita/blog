...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen relative flex items-start justify-center">
      <div className="border border-gray-900 bg-black bg-opacity-60 p-6 rounded-xl max-w-md w-full z-10 flex flex-col xl:mt-60 lg:mt-48 md:mt-45 sm:mt-40 mt-30">
